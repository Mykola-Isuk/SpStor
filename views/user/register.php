    ...
    <form method="post" action="" class="p-4 p-md-5 border rounded-3 form-signin w-100 m-auto bg-light">
        ...
        <div class="mb-3">
            <input type="email" class="form-control" name="login" id="login"
                   value="<?= htmlspecialchars(isset($model['login']) ? $model['login'] : '') ?>">
        ...
        <div class="mb-3">
            <input type="text" class="form-control" name="nick_name" id="nick_name"
                   value="<?= htmlspecialchars(isset($model['nick_name']) ? $model['nick_name'] : '') ?>">
            <?php if (!empty($errors['nick_name'])) : ?>
                <span class="error"> <?= htmlspecialchars($errors['nick_name']); ?></span>
            <?php endif; ?>
        </div>
        ...
        <div class="mb-3">
            ...
            <?php if (!empty($errors['password2'])) : ?>
                <span class="error"> <?= htmlspecialchars($errors['password2']); ?></span>
            <?php endif; ?>
        </div>
